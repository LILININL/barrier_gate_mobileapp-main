...
class FlutterRoundedDatePickerHeader extends StatelessWidget {
  const FlutterRoundedDatePickerHeader({Key? key, required this.selectedDate, required this.mode, required this.onModeChanged, required this.orientation, required this.era, required this.borderRadius, this.imageHeader, this.description = "", this.fontFamily, this.style}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    if (style?.textStyleDayButton?.color != null) {
      style?.textStyleDayButton = style?.textStyleDayButton?.copyWith(color: style?.textStyleDayButton?.color ?? dayColor);
    }
    ...
    final TextStyle dayStyle = style?.textStyleDayButton ?? headerTextTheme.headlineMedium!.copyWith(color: dayColor, fontFamily: fontFamily);
    final TextStyle yearStyle = style?.textStyleYearButton ?? headerTextTheme.titleMedium!.copyWith(color: yearColor, fontFamily: fontFamily);
