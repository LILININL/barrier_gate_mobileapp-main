...
class FlutterRoundedCupertinoDatePickerWidget extends StatefulWidget {
  ...
  FlutterRoundedCupertinoDatePickerWidget({this.mode = CupertinoDatePickerMode.dateAndTime, required this.onDateTimeChanged, DateTime? initialDateTime, this.minimumDate, this.maximumDate, this.minimumYear = 1, this.maximumYear, this.minuteInterval = 1, this.use24hFormat = false, this.borderRadius = 16, this.era, this.fontFamily, this.background = Colors.white, this.textColor = Colors.black54})
...
class _CupertinoDatePickerDateTimeState extends State<FlutterRoundedCupertinoDatePickerWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(color: widget.background, borderRadius: BorderRadius.only(topLeft: Radius.circular(widget.borderRadius), topRight: Radius.circular(widget.borderRadius))),
      child: MediaQuery(
...
class FlutterRoundedCupertinoDurationPickerWidget extends StatefulWidget {
  ...
  /// positive integer factor of 60.
  FlutterRoundedCupertinoDurationPickerWidget({this.mode = CupertinoTimerPickerMode.hms, this.initialTimerDuration = Duration.zero, this.minuteInterval = 1, this.secondInterval = 1, required this.onTimerDurationChanged, this.background = Colors.white, this.borderRadius = 16, this.fontFamily, this.textColor = Colors.black54})
  ...
  Widget _buildHourPicker() {
    return CupertinoPicker(
      ...
      children: List<Widget>.generate(24, (int index) {
        ...
        final String semanticsLabel = textDirectionFactor == 1 ? localizations.timerPickerHour(index) + localizations.timerPickerHourLabel(index)! : localizations.timerPickerHourLabel(index)! + localizations.timerPickerHour(index);
  ...
  Widget _buildMinutePicker() {
    ...
    return CupertinoPicker(
      ...
      children: List<Widget>.generate(60 ~/ widget.minuteInterval, (int index) {
        ...
        final String semanticsLabel = textDirectionFactor == 1 ? localizations.timerPickerMinute(minute) + localizations.timerPickerMinuteLabel(minute)! : localizations.timerPickerMinuteLabel(minute)! + localizations.timerPickerMinute(minute);
  ...
  Widget _buildSecondPicker() {
    ...
    return CupertinoPicker(
      ...
      children: List<Widget>.generate(60 ~/ widget.secondInterval, (int index) {
        ...
        final String semanticsLabel = textDirectionFactor == 1 ? localizations.timerPickerSecond(second) + localizations.timerPickerSecondLabel(second)! : localizations.timerPickerSecondLabel(second)! + localizations.timerPickerSecond(second);
