...
import 'register_reverse_external_person_view_model.dart';
export 'register_reverse_external_person_view_model.dart';

class RegisterReverseExternalPersonViewWidget extends StatefulWidget {
  const RegisterReverseExternalPersonViewWidget({super.key});

  @override
  State<RegisterReverseExternalPersonViewWidget> createState() =>
      _RegisterReverseExternalPersonViewWidgetState();
}

class _RegisterReverseExternalPersonViewWidgetState
    extends State<RegisterReverseExternalPersonViewWidget> {
  late RegisterReverseExternalPersonViewModel _model;
  ...
  void initState() {
    super.initState();
    _model =
        createModel(context, () => RegisterReverseExternalPersonViewModel());
    ...
    _model.textController6 ??= TextEditingController(
        text: dateTimeFormat("d MMMM y", _model.datePicked));
                            ...
                            child: ListView(
                              ...
                              children: [
                                Align(
                                  ...
                                  child: Text(
                                    'ลงทะเบียนรถยนต์บุคคลภายนอกอีกครั้ง',
